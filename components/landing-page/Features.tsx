  ...
  return (
    <section className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="mb-8 max-w-screen-md lg:mb-16">
        <h2 className="mb-4 text-4xl font-extrabold text-boxdark dark:text-white">
          Our services
        </h2>
        <p className="text-gray-500 sm:text-xl dark:text-gray-400">
          We offer a wide range of services to help you manage your property,
          employees, and tenants. From marketing to legal services, we have you
          covered.
        </p>
      </div>
